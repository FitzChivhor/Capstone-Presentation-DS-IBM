...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class',
                         ...
                         title='Correlation between Payload and Launch Success for All Launch Sites')
        return fig
    else:
